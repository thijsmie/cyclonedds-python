...
#else
  dds_UNUSED_ARG (sertype_a);
  dds_UNUSED_ARG (type_pair_b);
#endif
  return false;
}
...
static PyObject *
ddspy_domain_get_typeobj(PyObject *self, PyObject *args)
{
    dds_entity_t participant;
...
PyMethodDef ddspy_funcs[] = {
    ...
    {	"ddspy_take_endpoint",
		...
		ddspy_docs},
#ifdef DDS_HAS_TYPE_DISCOVERY
    {   "ddspy_domain_get_typeobj",
        (PyCFunction)ddspy_domain_get_typeobj,
        METH_VARARGS,
        ddspy_docs
    },
#endif
