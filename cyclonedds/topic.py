...
import ctypes as ct
from typing import Callable, Union, AnyStr, Optional, Generic, Type, TypeVar, TYPE_CHECKING

from .internal import c_call, c_callable, dds_c_t
...
_filter_fn = c_callable(ct.c_bool, [ct.POINTER(_CSample), ct.c_void_p])
...
class Topic(Entity, Generic[_S]):
    ...
    def set_topic_filter(self, callable: Callable[['Topic', _CSample], bool]):
