...
class DataWriter(Entity):
    ...
    def _get_liveliness_lost_status(self, writer: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_offered_deadline_missed_status")
    def _get_offered_deadline_missed_status(self, writer: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_offered_incompatible_qos_status")
    def _get_offered_incompatible_qos_status(self, writer: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_publication_matched_status")
    def _get_publication_matched_status(self, writer: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass