...
class DataReader(Entity):
    ...
    def _get_liveliness_changed_status(self, reader: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_requested_deadline_missed_status")
    def _get_requested_deadline_missed_status(self, reader: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_requested_incompatible_qos_status")
    def _get_requested_incompatible_qos_status(self, reader: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_sample_lost_status")
    def _get_sample_lost_status(self, reader: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_sample_rejected_status")
    def _get_sample_rejected_status(self, reader: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass

    @c_call("dds_get_subscription_matched_status")
    def _get_subscription_matched_status(self, reader: dds_c_t.entity, status: ct.POINTER(dds_c_t.inconsistent_topic_status)) -> dds_c_t.returnv:
        pass
