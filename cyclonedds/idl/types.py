...
class sequence(metaclass=__GetItemSupportMeta):
    @classmethod
    def __class_getitem__(cls, tup):
        if type(tup) != tuple:
            tup = (tup,)
...
class typedef(metaclass=__GetItemSupportMeta):
    @classmethod
    def __class_getitem__(cls, tup):
        if type(tup) != tuple:
            tup = (tup,)
...
class bounded_str(metaclass=__GetItemSupportMeta):
    @classmethod
    def __class_getitem__(cls, tup):
        if type(tup) != tuple:
            tup = (tup,)
...
class case(ValidUnionHolder, metaclass=__GetItemSupportMeta):
    @classmethod
    def __class_getitem__(cls, tup):
        if type(tup) != tuple:
            tup = (tup,)
...
class default(ValidUnionHolder, metaclass=__GetItemSupportMeta):
    @classmethod
    def __class_getitem__(cls, tup):
        if type(tup) != tuple:
            tup = (tup,)
